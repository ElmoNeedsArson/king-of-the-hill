...
execute as @a at @s if entity @s[x=0,z=0,distance=..41] \
...
execute positioned 0 75 0 run function koth:spawn_protection/ring
execute positioned 0 77 0 run function koth:spawn_protection/ring
execute positioned 0 79 0 run function koth:spawn_protection/ring
execute positioned 0 81 0 run function koth:spawn_protection/ring
