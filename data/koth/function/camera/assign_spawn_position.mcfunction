...
execute if score @s koth_camera matches 0 run tp @s 10000 310 0
execute if score @s koth_camera matches 1 run tp @s -10000 310 0
execute if score @s koth_camera matches 2 run tp @s 0 310 10000
execute if score @s koth_camera matches 3 run tp @s 0 310 -10000
execute if score @s koth_camera matches 4 run tp @s -5000 310 -8660
