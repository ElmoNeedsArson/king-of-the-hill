# Purple team claimed the beacon
...
execute unless score #beacon_color koth_camera matches 11 run playsound minecraft:block.beacon.activate master @a 0 101 0 20 1.2
