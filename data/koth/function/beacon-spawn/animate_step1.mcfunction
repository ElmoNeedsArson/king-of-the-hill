...
playsound minecraft:entity.wither.spawn master @a 0 266 0 20 0.8
...
playsound minecraft:ambient.cave ambient @a 0 266 0 20 0.7
playsound minecraft:block.portal.ambient ambient @a 0 266 0 20 1.2
